...
<html lang="en">
  ...
  <body style="background-color: rgb(195, 195, 195);">
    ...
    <input type="radio" name="opcao" value="opcao1"> Eliminar João Vitor<br>
    <input type="radio" name="opcao" value="opcao2">  Eliminar Tatiane <br>
    <input type="radio" name="opcao" value="opcao3">  Eliminar Samuel<br>
    <input type="radio" name="opcao" value="opcao4">  Eliminar Mathues<br>
